...
INSERT INTO dep_tbl (name) VALUES ('IT');

INSERT INTO emp_tbl (firstName, lastName, birthday, email, skype, icq, dep_id)
VALUES ('Steve', 'Wozniak', '1984-10-24', 'woz@woz.com', 'woz', '122112424124', 1);
INSERT INTO emp_tbl (firstName, lastName, birthday, email, skype, icq, dep_id)
VALUES ('Lea', 'Doug', '1984-10-24', 'lea@java.com', 'lea', '122112424124', 1);
UPDATE emp_tbl
SET head_id = 1
WHERE id = 2;
UPDATE dep_tbl
